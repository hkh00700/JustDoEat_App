...
public class WritingActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST && resultCode == RESULT_OK) {
            ...
            try {
                ...
                imageRealPath = ipConfig + "/ent/resources/" + uploadFileName;
            } catch (Exception e){
                e.printStackTrace();
            }
        }
    ...
    private void setPic() {
        ...
        String uploadFileName = imageRealPath.split("/")[imageRealPath.split("/").length - 1];
        imageRealPath = ipConfig + "/justdo_eat/resources/" + uploadFileName;
    }
    ...
    public void btnAddClicked(View view){
        ...
        if(isNetworkConnected(this) == true){
            ...
            if(fileSize <= 30000000){  // 파일크기가 30메가 보다 작아야 업로드 할수 있음
                ...
                Writing userReviewInsert = new Writing(s_title, s_content, s_nikname, s_phto_path, imageRealPath);
